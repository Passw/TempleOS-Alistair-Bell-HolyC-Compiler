...
/* 
    Lexer
*/
extern U8 HC_LexerCheckTerminationCharacterOrWhitespace(const I8 currentChar);
extern U8 HC_LexerCheckTerminationCharacterNotWhitespace(const I8 currentChar);
